...
//    }
    ...
    private class MapPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            int cellWidth = Math.round((this.getWidth() - 30) / mapString.length);
            int cellHeight = Math.round((this.getHeight() - 30) / mapString[0].length);
            ...
            int x0 = (this.getWidth() - cellWidth * mapString[0].length) / 2;
            int y0 = (this.getHeight() - cellHeight * mapString.length) / 2 - 30;
